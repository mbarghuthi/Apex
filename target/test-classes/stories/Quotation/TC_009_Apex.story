Scenario:  TC_009_Apex TC9S1 Apex Test Case Marine - Marine Hull - Hull And Machinery (Saudi Riyals)
...
And [Input] I click on 'MarineHullCard'
And [Input] I click on 'HullAndMachineryCard'
And [Assertion] Verify 'QutClassOfBusinessDisplay' equals 'p:MarineHull' text
And [Assertion] Verify 'QutPolicyTypeDisplay' equals 'p:HullAndMachinery' text
...
And [Javascript] I switch to iframe 'AddNewRiskIframe'
And [Input] Select 'p:RiskBasis' value from 'BreakdownCombobox' dropdown list
...
And [Assertion] Verify IG 'RISK_CALC_REGION_ig' row '17 - Marine Sum Insured' Local/Amount can be filled
And [Input] I set SECOND IG 'RISK_CALC_REGION_ig' from first row '17 - Marine Sum Insured' to random numbers between '1' and '50' for all enabled cells excluding DDL
And [Progress] I wait for '5' sec
!-- And [Input] I click on 'RiskCalculationSaveButton'
!-- And [Progress] I wait for '5' sec
And [Javascript] I switch back to main content
...
And [Progress] I wait for '5' sec
And [Assertion] Verify IG 'calc_ig' row '26 - Overage Premium' Local/Amount can be filled
And [Input] I set IG 'calc_ig' from first row '26 - Overage Premium' to random numbers between '1' and '50' for all enabled cells excluding DDL
...
Scenario:  TC_009_Apex TC9S2 Apex Test Case Marine - Marine Hull - Hull And Machinery (US Dollars)
...
And [Javascript] I switch to iframe 'RiskCalculationIframe'
And [Input] I click on 'RiskCalculationEditButton'
And [Assertion] Verify IG 'RISK_CALC_REGION_ig' row '17 - Marine Sum Insured' Foreign/Foreign Amount can be filled
And [Input] I set SECOND IG 'RISK_CALC_REGION_ig' from first row '17 - Marine Sum Insured' to random numbers between '1' and '50' for all enabled cells excluding DDL
And [Progress] I wait for '5' sec
!-- And [Input] I click on 'RiskCalculationSaveButton'
!-- And [Progress] I wait for '5' sec
...
And [Input] I click on 'EditButtonQuotationValue'
And [Progress] I wait for '5' sec
And [Assertion] Verify IG 'calc_ig' row '26 - Overage Premium' Foreign/Foreign Amount can be filled
And [Input] I set IG 'calc_ig' from first row '26 - Overage Premium' to random numbers between '1' and '50' for all enabled cells excluding DDL
And [Input] I click on 'SaveButton'
And [Progress] I wait for '5' sec
And [Navigation] I scroll to top of page
