...
public class ReportManager {
	...
	private static String reportName = "Apex-Automation-Report.html";
...
//		extent.config().reportName("Apex Automation Report");
//		extent.config().documentTitle("Apex Automation Report");
		return extent;
	}
