Scenario:  TC_009_Apex 001 Apex Test Case Marine - Marine Hull - Hull And Machinery (Saudi Riyals)
...
And [Assertion] Verify IG 'RiskCalculation_ig' row '17 - Marine Sum Insured' Local/Amount can be filled
And [Input] I set SECOND IG 'RiskCalculation_ig' from first row '17 - Marine Sum Insured' to random numbers between '1' and '50' for all enabled cells excluding DDL
And [Progress] I wait for '5' sec
...
Scenario:  TC_009_Apex 002 Apex Test Case Marine - Marine Hull - Hull And Machinery (US Dollars)
...
And [Navigation] I scroll to 'EditButton'
And [Input] I click on 'EditButton'
And [Assertion] Verify IG 'RiskCalculation_ig' row '17 - Marine Sum Insured' Foreign/Foreign Amount can be filled
And [Input] I set SECOND IG 'RiskCalculation_ig' from first row '17 - Marine Sum Insured' to random numbers between '1' and '50' for all enabled cells excluding DDL
And [Progress] I wait for '5' sec
And [Input] I click on 'SaveButton'
And [Progress] I wait for '5' sec
