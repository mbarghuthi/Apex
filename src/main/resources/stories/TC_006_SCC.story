...
And [Input] I select 'p:GeneralManagerOffice' from the 'General Manager Office Incoming SCC' combo box
And [Input] Select 'p:Other' value from 'Receiver Name Incoming SCC' dropdown list
And [Input] I select 'p:Other3496' from the 'Sub Receiver Name Incoming SCC' combo box
And [Input] I click on 'Save Draft Button'
And [Input] I click on 'Save Button'
And [Progress] I wait for '3' sec
And [Action] I get value from 'General Manager Office Incoming SCC' and save it as 'GeneralManagerOfficeComboBoxValue'
