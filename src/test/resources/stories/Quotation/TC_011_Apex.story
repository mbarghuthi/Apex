Scenario:  TC_011_Apex TC11S1 Apex Test Case FGA - Fire - Fire (Saudi Riyals)
...
And [Input] I click on 'FireCard'
And [Input] I click on 'FireCard'
And [Assertion] Verify 'QutClassOfBusinessDisplay' equals 'p:Fire' text
And [Assertion] Verify 'QutPolicyTypeDisplay' equals 'p:Fire' text
...
And [Assertion] Verify IG 'RISK_CALC_REGION_ig' row '42 - Fire SI' column 'Local' is filled and read-only

And [Progress] I wait for '5' sec
And [Javascript] I switch back to main content
And [Input] I click on 'RiskCalculationPopupCloseButton'
And [Navigation] I scroll to top of page
And [Input] I click on 'NextButton'
And [Progress] I wait for '5' sec
...
And [Assertion] Verify IG 'calc_ig' row '42 - Fire SI' column 'Amount' is filled and read-only
...
Scenario:  TC_011_Apex TC11S2 Apex Test Case FGA - Fire - Fire (US Dollars)
