Scenario:  TC_010_Apex TC10S1 Apex Test Case Marine - Marine Hull - Liability (Saudi Riyals)
...
And [Input] I click on 'LiabilityCard'
And [Assertion] Verify 'QutClassOfBusinessDisplay' equals 'p:MarineHull' text
And [Assertion] Verify 'QutPolicyTypeDisplay' equals 'p:Liability' text
...
Scenario:  TC_010_Apex TC10S2 Apex Test Case Marine - Marine Hull - Liability (US Dollars)
